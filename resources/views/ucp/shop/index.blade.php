		...
		<div class="am-u-sm-12 am-u-md-6">
			<div class="am-btn-toolbar">
				<div class="am-btn-group am-btn-group-xs">
					<a href="{{ route('shop.create') }}" type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> New Shop</a>
				</div>
			</div>
		</div>
		<!-- 标题工具栏 -->
				...
				<table class="am-table am-table-striped am-table-hover table-main">
					<thead>
						...
						<tbody>
							...
							<tr>
								<td>{{ $shop->id }}</td>
								<td><a href="{{route("shop.show", $shop->id)}}">{{ $shop->shop_name }}</a></td>
								...
								<div class="am-btn-toolbar">
									<div class="am-btn-group am-btn-group-xs">
									<a href="{{route("shop.edit", $shop->id)}}" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> Edit</a>
